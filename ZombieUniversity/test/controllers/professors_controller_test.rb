...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { name: @professor.name, number: @professor.number, numberOfBrainsEaten: @professor.numberOfBrainsEaten }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { name: @professor.name, number: @professor.number, numberOfBrainsEaten: @professor.numberOfBrainsEaten }
    assert_redirected_to professor_path(assigns(:professor))
  end
